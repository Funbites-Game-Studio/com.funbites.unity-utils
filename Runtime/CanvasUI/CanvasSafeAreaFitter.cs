...
namespace ScriptUtils.UI {
    [RequireComponent(typeof(Canvas)), ExecuteInEditMode]
    public class CanvasSafeAreaFitter : MonoBehaviour {
        /*
        ...
        */
        ...
        private static List<CanvasSafeAreaFitter> helpers = new List<CanvasSafeAreaFitter>();
        ...
        private RectTransform m_safeAreaTransform = null;
        ...
        public static Vector2 GetSafeAreaSize() {
            for (int i = 0; i < helpers.Count; i++) {
                if (helpers[i].m_safeAreaTransform != null) {
                    return helpers[i].m_safeAreaTransform.sizeDelta;
                }
            }
